	...
	<form action="joinProcess.jsp" method="post">
		...
		<p>
			...
			<label><input type="radio" id="gender" name="gender" 
			         value="남성" checked>남성</label>
			<label><input type="radio" id="gender" name="gender" 
			        value="여성" >여성</label>
		</p>
		<p>
			<label for="hobby">취 미: </label>
			<label><input type="checkbox" id="hobby1" name="hobby" 
			              value="독서">독서</label>
			<label><input type="checkbox" id="hobby2" name="hobby" 
			              value="운동">운동</label>
			<label><input type="checkbox" id="hobby3" name="hobby" 
			              value="영화">영화</label>
