...
<body>
   ...
   <div class="container">
     <form action="./processUpdateMember.jsp" method="post" onsubmit="return checkForm()" name="updateMember">
     	...
     	<div class="form-group row">
     		<label class="col-sm-2">생일</label>
   			<div class="col-sm-3">
   				<input type="text" name="birthyy" value="${year}" placeholder="년(yyyy)" maxlength="4" size="6">
   				<select name="birthmm">
   					<option>월</option>
