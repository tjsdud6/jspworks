   ...
   <div class="container">
      ...
      <form action="./processAddProduct.jsp" method="post"
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-5">
               <lable><input type="radio" name="condition" value="New "> <fmt:message key ="condition_New"/></lable>
               <lable><input type="radio" name="condition" value="Old "> <fmt:message key ="condition_Old"/></lable>
               <lable><input type="radio" name="condition" value="Refurbished "> <fmt:message key ="condition_Refurbished"/></lable>
            </div>
         </div>
         <div class="form-group row">
